class ReservasController < ApplicationController
  ...
  private
    ...
    def reserva_params
      params.require(:reserva).permit(:codigo, :direccion_origen, :distrito_origen, :direccion_destino, :distrito_destino, :cantidad_pasajeros, :categoria, :tarifa_final, :metodo_pago, :estado, :chofer, :usuario, :created, :updated)
    end
end
